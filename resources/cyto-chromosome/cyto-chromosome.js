...
(function(cyto_chr, d3) {
  ...
  Chromosome.prototype.newSelector = function(bp_start, bp_stop) {
    ...
    var ve = cyto_chr.selector(selectorRemoveCB);
      ve.x(cyto_chr.margin.left);
      ve.y(cyto_chr.margin.top - (this._height / 4));
      ve.height(this._height + (this._height / 2));
      ve.xscale(this.xscale);
      ve.extent([bp_start, bp_stop]);
      ve.target(self._domTarget);
      ve.render();
...
(function (cyto_chr, d3) {
  ...
  var baseDir = '/resources/cyto-chromosome/data/';
